...
def _build_draft_internal(marketplace: str, order_id: str, template_key: str | None = None) -> dict[str, Any]:
    ...
    if market not in ALLOWED_MARKETPLACES:
        raise InvoiceServiceError(400, "marketplace must be shopify, kaufland, or amazon")
    if market == "amazon":
        raise InvoiceServiceError(400, "Amazon-FBA sales invoices are not generated by this dashboard")
